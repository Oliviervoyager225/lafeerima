      ...
      <main className="historique-main">
        ...
        <section className="hist-section section-1">
          <div className="hist-content">
            ...
            <p>
              À La FéeRima, l’accueil, l’écoute et le respect sont au cœur de notre pratique. Ils établissent un climat de confiance, de qualité et de sécurité, essentiel pour accompagner les jeunes et leurs familles tout au long de leur parcours.
            </p>
          </div>
